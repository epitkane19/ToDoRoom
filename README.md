...
- Datavirran kulku: UI aktivoi toiminnan (taskin lisäys, päivitys tai poisto esimerkiksi). ViewModel saa tiedon tästä ja siirtää etiäpäin repository funktiolle. Repository kutsuu oikean DAO metodin. Dao lukee ja kirjoittaa dataa Room tietokannassa. Room palauttaa tiedon takaisin aina ViewModeliin asti mistä lopuksi UI saa tiedon ja päivittyy.
